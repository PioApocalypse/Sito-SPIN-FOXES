...
The programme of the workshop is available for download link:/FOXES_20-21oct.pdf[*here*^]. Preview:

image:/work/FOXES_workshop_calendar.png[title="Calendar", width="100%", link=/work/FOXES_workshop_calendar.png, window=_blank]
